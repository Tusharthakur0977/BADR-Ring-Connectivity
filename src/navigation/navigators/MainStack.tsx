...
export type MainStackParamList = {
  ...
  BADR_RING_SCREEN: undefined
  BADR_RING_SIMULATOR_SCREEN: undefined
}
...
export function MainStackComponent() {
  ...
  return (
    <MainStack.Navigator screenOptions={commonScreenOptions}>
      ...
      />
      <MainStack.Screen
        name="BADR_RING_SCREEN"
        component={screenComponents.BADRRingScreen}
        options={{
          headerTitle: 'BADR Ring'
        }}
      />
      <MainStack.Screen
        name="BADR_RING_SIMULATOR_SCREEN"
        component={screenComponents.BADRRingSimulatorScreen}
        options={{
          headerTitle: 'BADR Ring Simulator'
        }}
      />
    </MainStack.Navigator>
  )

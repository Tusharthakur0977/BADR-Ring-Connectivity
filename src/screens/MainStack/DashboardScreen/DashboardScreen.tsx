...
export function DashboardScreen({ navigation }: DashboardScreenProps) {
  ...
  return (
    <ScreenDefaultContainer>
      ...
      <AppButton
        label=" Scan BADR Ring"
        onPress={() => navigation.navigate("BADR_RING_SCREEN")}
      />
      <AppButton
        label="BADR Ring Simulator (enable prototype)"
        onPress={() => navigation.navigate("BADR_RING_SIMULATOR_SCREEN")}
      />
      <FlatList
        style={{ flex: 1 }}
        data={foundDevices}
